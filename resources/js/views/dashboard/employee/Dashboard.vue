          ...
          <section class="col-lg-5 connectedSortable">
            <div class="card ">
              ...
              <div class="card-body" style="height: 300px;">
                <ul class="list-group">
                  <li class="list-group-item" v-for="(sale, index) in latestSales.data" :key="index">
                    {{sale.product.name}} 
                    <span class="badge badge-primary">{{sale.quantity}}</span>
                  </li>
                </ul>
              </div>
            </div>
  ...
  methods: {
    getDashboard: async function(){
      try {
        ...
        this.latestSales = response.data.latestSales;
        // console.log(this.latestSales)
